...
export const getDetail = (data) => {
  return http({
    url: '/windmanagement/windReport/queryByNotifyId',
    method: 'GET',
    query: data,
  })
}
...
export const getShip = (data) => {
  return http({
    url: '/windmanagement/windReport/getShipList',
    method: 'GET',
    params: data,
  })
}
...
export const add = (data) => {
  return http({
    url: '/windmanagement/windReport/add ',
    method: 'POSt',
    data,
  })
}
...
export const edit = (data) => {
  return http({
    url: '/windmanagement/windReport/edit ',
    method: 'PUT',
    data,
  })
}
